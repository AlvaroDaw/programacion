 ...
 * numeros aleatorios entre 500 y 900. A continuación, el programa debe mostrar los numeros de la
 * diagonal que va desde la esquina inferior izquierda a la esquia superior derecha, asi como el
 * maximo, el minimo y la media de los numeros que hay en esa diagonal.
 * 
 * @author Alvaro Ramirez
 *
 */
public class EjercicioBD12 {
